  ...
  return (
    <>
      ...
      <Passo n={10} titulo="Livro diário" imagem="manual-aluno-10-livro-diario.png">
        ...
        <p>Se o professor devolver um lançamento (aparece como "Correção necessária", em vermelho), <b>clique nele na tabela</b> — a observação do professor aparece no topo do formulário, já com os dados preenchidos para você ajustar e reenviar. O ciclo se repete até o professor aprovar.</p>
      </Passo>
